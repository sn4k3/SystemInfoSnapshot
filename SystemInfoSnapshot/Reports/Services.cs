        ...
        protected override void Build()
        {
            if (SystemHelper.IsWindows)
            {
                ...
                foreach (var service in services)
                {
                    ...
                    HtmlWriter.AddAttribute("data-value", Convert.ToByte(service.CanPauseAndContinue).ToString());
                    ...
                    HtmlWriter.AddAttribute("data-value", Convert.ToByte(service.CanShutdown).ToString());
                    HtmlWriter.RenderBeginTag(HtmlTextWriterTag.Td);
                    ...
                    HtmlWriter.AddAttribute("data-value", Convert.ToByte(service.CanStop).ToString());
                    HtmlWriter.RenderBeginTag(HtmlTextWriterTag.Td);
